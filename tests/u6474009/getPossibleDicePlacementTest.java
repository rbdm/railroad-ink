...
public class getPossibleDicePlacementTest {
    ...
    public void testFullBoard() {
        String FULL_BOARD_STRING = "A0F00A0B00A0A31B1A14A0B61A0F61A0G32B1D61A0G43A0A62A0E61B1G56S1G60A0E03A0A03B1G12A0G02S0A50A0B50A5D03B1B40A0A40";
        for (String d : VALID_DICES) {
            Board board = new Board();
    ...
    /**
     * Checks if the right exception is thrown for illegal input.
     */
